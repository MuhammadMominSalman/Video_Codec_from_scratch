...
if intra == 0
    ...
    quantised_image = blockbased_deadzone_quantizer_to_levels(transformed_image, quantisation_matrix);
    ...
    i_image = blockbased_deadzone_dequantizer_from_levels(input_levels_pred, quantisation_matrix);
...
if intra == 1
    ...
    save(coded_file, 'width', 'height', 'transform_blocksize', 'qp', 'huffman_table', 'bitstream', ...
        'huffman_table_mv', 'bitstream2', 'resd', 'presd', ...
        'motion_vectors_allframes', 'me_blocksize', 'me_searchrange');
    coded_bits = bitstream_get_length(bitstream);
end
